...
public class Treasure_generator {
	...
	private String[] weapon = { "меч", "двуручный меч", "топор", "двуручный топор", "молот", "двуручный молот",
			"лук", "арбалет", "мушкет", "посох", "волшебна€ палочка", "копьЄ", "кинжал", "алебарда" };
	private String[] weapon_and_armor_suffix = { "€рости", "стального ветра", "быстроты", "мощи", "грозы",
			"тирана", "лидера", "гладиатора", "военачальника", "огн€", "ветра", "воздуха", "земли", "света", "тьмы",
			"природы", "убийцы драконов", "убийцы великанов", "из иного мира" };
	private String[] liquid = { "эликсир", "зелье", "снадобье", "настой", "масло", "мазь" };
	private String[] liquid_suffix = { "лечени€", "исцелени€", "отравлени€", "выведени€ €дов", "регенерации",
			"взрыва", "защиты от огн€", "защиты от воды", "защиты от земли", "защиты от воздуха" };
	private String[] armor = { "полный латный доспех", "полулатный доспех", "кольчуга", "кожана€ брон€",
			"манти€" };
