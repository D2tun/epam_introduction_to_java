...
/* Ќа плоскости заданы своими координатами n точек. Ќаписать метод(ы), определ€ющие, между какими
...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("–ассто€ние между " + i_max + "-й и " + j_max + "-й точками - наибольшее.");
	}
