...
/* ƒаны дроби p1/q1, p2/q2, ..., pn/qn (pi, qi - натуральные). —оставить программу, котора€ приводит эти
дроби к общему знаменателю и упор€дочивает их в пор€дке возрастани€. */
